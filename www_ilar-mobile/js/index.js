window.onload = function () {
  ...
  // call -> write
  document.body.getElementsByClassName('call__hat__button-write')[0].addEventListener('click', () => {
    document.body.getElementsByClassName('write')[0].classList.add('write--opened');
  });

  // call -> close
  document.body.getElementsByClassName('call__hat__button-close')[0].addEventListener('click', () => {
  ...
  // main__screen-0 (burger) -> call
  document.body.getElementsByClassName('main__screen-0__head__button')[0].addEventListener('click', () => {
    document.body.getElementsByClassName('call')[0].classList.add('call--opened');
  });
  ...
  // main__screen-7__button -> write
  document.body.getElementsByClassName('main__screen-7__button')[0].addEventListener('click', () => {
    document.body.getElementsByClassName('write')[0].classList.add('write--opened');
  });
